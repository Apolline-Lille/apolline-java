...
/**
 * This class represent the command for read the value of bins in the of data send by the sensor
 */
public class ReadBinCmd extends ReadDataCmd{
    ...
    /**
     * This class represent the command for read the value of bins in the list of data send by the sensor
     ...
     */
    public ReadBinCmd(OutputStream out, InputStream is) {
        super(out, is);
        data=new byte[2];
    }
