...
/**
 * This class represent the command for stop fan and laser of the sensor
 */
public class StopFanCmd extends ParticuleCmd{

    /**
     * bytes array reprensent the command for stop fan and laser of the sensor
     */
    protected static final byte[] CMD1={(byte)0x61,(byte)0x03};
    protected static final byte[] CMD2={(byte)0x61,(byte)0x01};
     ...
     */
    public StopFanCmd(OutputStream out, InputStream is) {
        super(out, is);
        readByte=new byte[2];
    }
